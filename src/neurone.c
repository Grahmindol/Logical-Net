...
float dfb_and(float a, float b) { (void)b; return (a + 1.0f) / 2.0f; }
float dfb_nand(float a, float b) { return -dfb_and(a, b); }
float dfb_or(float a, float b) { (void)b; return (1.0f - a) / 2.0f; }
float dfb_nor(float a, float b) { return -dfb_or(a, b); }
float dfb_xor(float a, float b) { (void)b; return -a; }
float dfb_xnor(float a, float b) { (void)b; return a; }
float dfb_a(float a, float b) { (void)a; (void)b; return 0.0f; }
float dfb_b(float a, float b) { (void)a; (void)b; return 1.0f; }
float dfb_a_or_not_b(float a, float b) { (void)b; return ( -a + 1.0f ) / 2.0f; }
float dfb_not_a_or_b(float a, float b) { (void)b; return (a + 1.0f) / 2.0f; }
float dfb_nand_a(float a, float b) { (void)b; return ( -a + 1.0f ) / 2.0f; }
float dfb_nand_b(float a, float b) { (void)b; return ( -a - 1.0f ) / 2.0f; }
